abstract class Routes {
  ...
  static const String basketItemDetails = "$basket/item";
  static const String basketOverview = "$basket/overview";
  static const String libraryItemTemplateDetails = "$library/item-template";
